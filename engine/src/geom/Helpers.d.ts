...
export declare function lineLineIntersect(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number, x4: number, y4: number): IPoint | null;
export declare function lineSide(x: number, y: number, x1: number, y1: number, x2: number, y2: number): number;
export declare function boundsLineIntersect(b: IBounds, segPtA: IPoint, segPtB: IPoint): Array<IPoint> | null;
export declare function circleLineIntersect(bnds: IBounds, segPtA: IPoint, segPtB: IPoint): Array<IPoint> | null;
export declare function rectLineIntersect(b: IBounds, segPtA: IPoint, segPtB: IPoint, side?: number): Array<IPoint> | null;
...
export declare function linePolygonIntersect(linePtA: IPoint, linePtB: IPoint, poly: IPolygon): Array<IPoint> | null;
...
export declare function resolvePenetrationBetweenBounds(): IPoint | null;
export declare function getPenetrationSegmentRound(): IPoint | null;
export declare function resolvePenetrationOrthoRound(bA: IBounds, bB: IBounds): IPoint | undefined;
